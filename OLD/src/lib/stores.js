...
if (browser) {
    language.subscribe((value) => {
        ...
        // Notify layout/pages to refresh dependent UI
        window.dispatchEvent(new CustomEvent('settings-updated', { detail: { reason: 'language', value } }));
    });
    ...
    theme.subscribe((value) => {
        ...
        // Notify layout/pages to refresh dependent UI
        window.dispatchEvent(new CustomEvent('settings-updated', { detail: { reason: 'theme', value } }));
    });
}
...
const translationsData = {
    de: {
        ...
        autoSave: 'Auto-Save',
        analytics: 'Analytics',
        privacyMode: 'Privatsphäre',
        emailUpdates: 'E-Mail Updates',
        liquidToggle: 'Liquid Toggle',
        active: 'Aktiviert',
